//sprites
var mom1, mom2,last ;
var brother,father,grandma,grandpa,mother,sister;
//colorPicker and other variables which help connect with other classes
var   colorPicker, form,game,player;
//database variable and other sprites/elements which help in switching of gameStates
var database, next, sel, cross , pick, send, send2,textMore;
//variables assigned different values to show different parts of the game
var seen="seen";
var gameState=0;
var state=0;
//variables showing text inputed by the user
var input11, input22;
...
var rec, mic ,file;
//variables holding x, y and limit of some texts
var x1,y1,d1,x,y,d;
 //variables for images
var choose1, mom1i, mom2i,mic2, crossi, nexti,last1,mic1;
var brother1,father1,grandma1,grandpa1,mother1,sister1,send1;
...
//this sprite is found when you are selecting your emotion.
//it is pressed to go to the next state where the coversation begins.
...
next2.scale=0.2;
next2.visible=false;
//these are the 2 sprites on the first screen/gameState.
...
if(gameState===0){
//giving the value inputed by the user in a variable.
...
//this will be helpful after entering user's name and listner's name.
next=createSprite(displayWidth/2+600,displayHeight/2+200,10,30);next.addImage(nexti);
next.scale=0.2;
next.setCollider("rectangle",0,0,400,400);
}
}
function draw(){
  //to check in which state is the game. 
 console.log( gameState)
 //to change the color of the background as choosed by the user
...
function writing2(){
var x1=displayWidth/4-250
var y1=displayHeight/4+100
